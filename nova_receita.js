...
const cadastrarButton = document.querySelector("#cadastro_receita");



const cadastrar = async () => {
	cadastrarButton.value = "Cadastrando...";

  
	const nameInput = document.querySelector("#nome_paciente");
	const validInput = document.querySelector("#validade_receita");
	const descriptionInput = document.querySelector("#description_receita");
  
	patient_name = nameInput.value;
	valid_date = validInput.valueAsNumber;
	description = descriptionInput.value;
	if (!await contrato.valid_patient(await contrato.patient_address(patient_name))) {
		cadastrarButton.value = "Cadastrar receita";
		window.alert("Nome do usuário errado.");
		return
	}

	//TRATAR DATA MAIOR QUE A DE HOJE.
	...
	await contrato.new_prescription(Date.now(), valid_date, description, patient_name);
	cadastrarButton.value = "Cadastrar receita";
